...
describe('The postcss-add-nesting plugin', () => {
  describe('given two rules', () => {
    ...
    describe('if each rule is in an at-rule', () => {
      ...
      describe.skip('if the second at-rule can be nested inside the first', () => {
        describe('if the selectors are unrelated', () => {
          ...
          it('nests @container rules', async () => {
            await run(
              `@container (scrollable: block-end) {
                heading::after {
                  content: "scroll down";
                }
              }
              @container (scrollable: block-end) and (block-size > 600px) {
                p em {
                  color: blue;
                }
              }`,
      ...
      describe.skip('if the first at-rule can be nested inside the second', () => {
        describe('if the selectors are unrelated', () => {
          it('nests @media rules', async () => {
            await run(
          ...
          it('nests @container rules', async () => {
            await run(
              `@container style(--theme: one) and (height < 400px) {
                aspect-ratio: 1 / 2;
              }
